...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = PhoneAlreadyOccupiedException.class)
    public ResponseEntity<ErrorResponseDto> handlePhoneAlreadyOccupiedException(PhoneAlreadyOccupiedException e,
                                                                                WebRequest webRequest){
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
    ...
    @ExceptionHandler(value = LoginAlreadyOccupiedException.class)
    public ResponseEntity<ErrorResponseDto> handlePhoneAlreadyOccupiedException(LoginAlreadyOccupiedException e,
                                                                                WebRequest webRequest){
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                HttpStatus.BAD_REQUEST,
                e.getMessage(),
